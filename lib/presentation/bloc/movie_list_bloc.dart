...
class NowPlayingMoviesBloc
    extends Bloc<MovieListEvent, NowPlayingMoviesState> {
...
class PopularMoviesBloc extends Bloc<MovieListEvent, PopularMoviesState> {
...
class TopRatedMoviesBloc extends Bloc<MovieListEvent, TopRatedMoviesState> {
